...
//!
//! Why a separate module from the data-plane handlers (`velocity-data-api`):
//!
...
//!    `PlatformState::platform_audit_token` (constant-time).
...
//!
//! [`ResolvedSchema`]: velocity_core::registry::ResolvedSchema
...
use velocity_core::audit::{self, action, outcome, AUDIT_SELF_SCHEMA_ORG};
