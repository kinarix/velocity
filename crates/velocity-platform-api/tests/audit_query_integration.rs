...
fn build_app(pool: PgPool, with_token: bool) -> axum::Router {
    ...
    let mut state = PlatformState::new(registry, pool);
    ...
    router::build_platform_api(state)
}
